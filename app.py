        ...
        try:
            ...
            def map():
                ...
                if True:
                    ...
                    g = geocoder.osm(str(city))
                    lat_lon = [g.json['lat'], g.json['lng']]
                    print('After Geocoder & Map: ', lat_lon)
                    if int(crater_diameter) > 60000:
                        ...
                        folium.Circle(location=lat_lon, radius=crater_diameter * 3,
                                      tooltip="Human Skin May Burn | Infastructure destroyed | Flying Debris Fatal ",
                                      color='#ff6666', fill=True,
                                      fill_color='#ff6666', zoom_start=5).add_to(m)
                        folium.Circle(location=lat_lon, radius=crater_diameter * 1.45,
                        ...
                        folium.Circle(location=lat_lon, radius=crater_diameter / 1.5,
                                      tooltip="Crater Area | Anything Living Dies ", color='orange', fill=True,
                                      fill_color='orange', zoom_start=5).add_to(m)
                        folium.Circle(location=lat_lon, radius=int(diameter),
                                      tooltip="Original Size of Asteroid | Click", color='grey',
                                      fill=True,
                                      fill_color='grey', zoom_start=5).add_to(m)
                        print(diameter)
                        ...
                        folium.Circle(location=lat_lon, radius=int(diameter),
                                      tooltip="Original Size of Asteroid | Click",
